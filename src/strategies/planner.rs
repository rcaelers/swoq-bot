    ...
    pub fn new() -> Self {
        Self {
            strategies: vec![
                ...
                Box::new(drop_boulder_on_plate::DropBoulderOnPlateStrategy),
                Box::new(drop_boulder::DropBoulderStrategy),
                Box::new(use_pressure_plate_for_door::UsePressurePlateForDoorStrategy),
                Box::new(open_door_with_key::OpenDoorWithKeyStrategy),
                Box::new(get_key_for_door::GetKeyForDoorStrategy),
                Box::new(reach_exit::ReachExitStrategy),
                Box::new(fetch_boulder_for_plate::FetchBoulderForPlateStrategy),
